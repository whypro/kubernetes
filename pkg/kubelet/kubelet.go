...
func (kl *Kubelet) initializeModules() error {
	// Prometheus metrics.
	metrics.Register(kl.runtimeCache, collectors.NewVolumeStatsCollector(kl.resourceAnalyzer))
	...
	if err := kl.containerManager.Start(node, kl.cpuOvercommitRatioGetter(), kl.GetActivePods); err != nil {
